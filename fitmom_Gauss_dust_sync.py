...
p0=[5e2, 1.54, 20, 10, -3,1, 0] #first guess for mbb A, beta, T, r
...
an.plotr_gaussproduct(resultso1bt_PL,Nmax=15,debug=False,color='darkorange',save=True,kwsave='d%ss%s_fullo1bT_fix%s'%(synctype,dusttype,fix))
