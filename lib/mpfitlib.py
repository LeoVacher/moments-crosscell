...
def func_ds_o0_all_ell(p,fjac=None, x1=None, x2=None, y=None, err=None,nuref=353.,nurefs=23.,Nell=None,DL_lensbin=None, DL_tens=None):
    ...
    nu_i=x1
    nu_j=x2
    mbb = np.repeat(p[:Nell],253)*func.mbb_uK(nu_i, p[ellim+1], p[ellim+2],nu0=nuref) * func.mbb_uK(nu_j, p[ellim+1], p[ellim+2],nu0=nuref)
    sync = np.repeat(p[Nell:2*Nell],253)*func.PL_uK(nu_i, p[ellim+3],nu0=nurefs) * func.PL_uK(nu_j, p[ellim+3],nu0=nurefs)
...
def func_ds_o1bts_all_ell(p,fjac=None, x1=None, x2=None, y=None, err=None,nuref=353,nurefs=23.,ell=None,DL_lensbin=None, DL_tens=None):
    ...
    crossdustsync2 = p[ellim+10]*(func.mbb_uK(nu_i,p[ellim+1],p[ellim+2],nu0=nuref)*lognui*func.PL_uK(nu_j,p[ellim+3],nu0=nurefs)+ func.PL_uK(nu_i,p[ellim+3],nu0=nurefs)*func.mbb_uK(nu_j,p[ellim+1],p[ellim+2],nu0=nuref)*lognuj)
    crossdustsync3 = p[ellim+11]*(func.mbb_uK(nu_i,p[ellim+1],p[ellim+2],nu0=nuref)*(dxi-dx0)*func.PL_uK(nu_j,p[ellim+3],nu0=nurefs)+ func.PL_uK(nu_i,p[ellim+3],nu0=nurefs)*func.mbb_uK(nu_j,p[ellim+1],p[ellim+2],nu0=nuref)*(dxj-dx0))
    crossdustsync4 = p[ellim+12]*(func.mbb_uK(nu_i,p[ellim+1],p[ellim+2])*lognujs*func.PL_uK(nu_j,p[ellim+3])+ func.PL_uK(nu_i,p[ellim+3])*func.mbb_uK(nu_j,p[ellim+1],p[ellim+2])*lognuis)/(func.PL_uK(nurefs,p[4])*func.mbb_uK(nuref,p[ellim+1],p[ellim+2]))
    crossdustsync5 = p[ellim+13]*(func.mbb_uK(nu_i,p[ellim+1],p[ellim+2])*lognui*func.PL_uK(nu_j,p[ellim+3])*lognujs+ func.PL_uK(nu_i,p[ellim+3])*lognuis*func.mbb_uK(nu_j,p[ellim+1],p[ellim+2])*lognuj)/(func.PL_uK(nurefs,p[ellim+3])*func.mbb_uK(nuref,p[ellim+1],p[ellim+2]))
    crossdustsync6 = p[ellim+14]*(func.mbb_uK(nu_i,p[ellim+1],p[ellim+2])*(dxi-dx0)*func.PL_uK(nu_j,p[ellim+3])*lognujs+ func.PL_uK(nu_i,p[ellim+3])*lognuis*func.mbb_uK(nu_j,p[ellim+1],p[ellim+2])*(dxj-dx0))/(func.PL_uK(nurefs,p[ellim+3])*func.mbb_uK(nuref,p[1],p[ellim+3]))
