...
def func_ds_o1bp(p,fjac=None, x1=None, x2=None, y=None, err=None,nuref=353,nurefs=23.,ell=None,DL_lensbin=None, DL_tens=None):
    ...
    nu_i=x1
    nu_j=x2
    ampl = func.mbb_uK(nu_i,p[1],1/p[2],nu0=nuref)*func.mbb_uK(nu_j,p[1],1/p[2],nu0=nuref)
    sync= p[3]*func.PL_uK(nu_i,p[4],nu0=nurefs)*func.PL_uK(nu_j,p[4],nu0=nurefs)
    normcorr= np.sqrt(abs(p[0]*p[3]))
    #normcorr= 1
    crossdustsync= p[5]*normcorr*(func.mbb_uK(nu_i,p[1],1/p[2],nu0=nuref)*func.PL_uK(nu_j,p[4],nu0=nurefs)+ func.PL_uK(nu_i,p[4],nu0=nurefs)*func.mbb_uK(nu_j,p[1],1/p[2],nu0=nuref))
    lognui = np.log(nu_i/nuref)
    lognuj = np.log(nu_j/nuref)
...
def func_ds_o1bts(p,fjac=None, x1=None, x2=None, y=None, err=None,nuref=353,nurefs=23.,ell=None,DL_lensbin=None, DL_tens=None):
    ...
    crossdustsync2 = p[13]*(func.mbb_uK(nu_i,p[1],1/p[2],nu0=nuref)*lognui*func.PL_uK(nu_j,p[4],nu0=nurefs)+ func.PL_uK(nu_i,p[4],nu0=nurefs)*func.mbb_uK(nu_j,p[1],1/p[2],nu0=nuref)*lognuj)
    crossdustsync3 = p[14]*(func.mbb_uK(nu_i,p[1],1/p[2],nu0=nuref)*(dxi-dx0)*func.PL_uK(nu_j,p[4],nu0=nurefs)+ func.PL_uK(nu_i,p[4],nu0=nurefs)*func.mbb_uK(nu_j,p[1],1/p[2],nu0=nuref)*(dxj-dx0))
