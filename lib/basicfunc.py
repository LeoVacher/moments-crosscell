...
def model_mbb_moments(nside,nu,model,mom,tempmap,nu0=353.,maxborder=3,maxtorder=3,nside_moments=512,mult_factor=1.):
    ...
    nuval = nu * 1e9
    nu0val = nu0 * 1e9
    Bval = 2*constants.h.value*(nuval**3)/constants.c.value**2
    Cval = constants.h.value*nuval/constants.k_B.value
    Bval0 = 2*constants.h.value*(nu0val**3)/constants.c.value**2
    Cval0 = constants.h.value*nu0val/constants.k_B.value
