...
def plotmed(ell,label,res,color='darkblue',marker="D",show=True,legend=''):
    ...
    name = {'A_d':r'$A^d$','beta_d':r'$\beta^d$','T_d':r'$T^d$','beta_s':r'$\beta^s$','A_s':r'$A^s$','A_sd':r'$A^{sd}$','r':r'$\hat{r}$','X2red':r'$\chi^2_{\rm red}$','Aw1b':r'$\mathcal{D}_\ell^{A_d\times\omega_1^{\beta}}$','Aw1t':r'$\mathcal{D}_\ell^{A_d\times\omega_1^{1/T}}$','Asw1bs':r'$\mathcal{D}_\ell^{A_s\times\omega_1^{\beta^s}}$','w1bw1bs':r'$\mathcal{D}_\ell^{\omega_1^{\beta^d}\times\omega_1^{\beta^s}}$','w1tw1bs':r'$\mathcal{D}_\ell^{\omega_1^{1/T}\times\omega_1^{\beta^s}}$','w1bw1b':r'$\mathcal{D}_\ell^{\omega_1^\beta\times\omega_1^\beta}$','w1tw1t':r'$\mathcal{D}_\ell^{\omega_1^{1/T}\times\omega_1^{1/T}}$','w1bw1t':r'$\mathcal{D}_\ell^{\omega_1^\beta\times\omega_1^{1/T}}$','w1bsw1bs':r'$\mathcal{D}_\ell^{\omega_1^{\beta^s}\times\omega_1^{\beta^s}}$', 'Asw1b':r'$\mathcal{D}_\ell^{A_s\times\omega_1^{\beta}}$','Asw1t':r'$\mathcal{D}_\ell^{A_s\times\omega_1^{1/T}}$','Aw1bs':r'$\mathcal{D}_\ell^{A_d\times\omega_1^{\beta^s}}$'}
...
def plothist(label,res,colors='darkblue',r=0):
    ...
    namemom = {'Aw1b':r'$\mathcal{D}_\ell^{A_d\times\omega_1^{\beta}}$','Aw1t':r'$\mathcal{D}_\ell^{A_d\times\omega_1^{1/T}}$','Asw1bs':r'$\mathcal{D}_\ell^{A_s\times\omega_1^{\beta^s}}$','w1bw1bs':r'$\mathcal{D}_\ell^{\omega_1^{\beta^d}\times\omega_1^{\beta^s}}$','w1bswt':r'$\mathcal{D}_\ell^{\omega_1^{1/T}\times\omega_1^{\beta^s}}$','w1bw1b':r'$\mathcal{D}_\ell^{\omega_1^\beta\times\omega_1^\beta}$','w1tw1t':r'$\mathcal{D}_\ell^{\omega_1^{1/T}\times\omega_1^{1/T}}$','w1bw1t':r'$\mathcal{D}_\ell^{\omega_1^\beta\times\omega_1^{1/T}}$','w1bsw1bs':r'$\mathcal{D}_\ell^{\omega_1^{\beta^s}\times\omega_1^{\beta^s}}$', 'Asw1b':r'$\mathcal{D}_\ell^{A_s\times\omega_1^{\beta}}$','Asw1t':r'$\mathcal{D}_\ell^{A_s\times\omega_1^{1/T}}$','Aw1bs':r'$\mathcal{D}_\ell^{A_d\times\omega_1^{\beta^s}}$'}
...
def plotrespdf(l, res, legs, colors,mom_an=None,plot_contours=False,betadbar=1.54,tempbar=20.,betasbar=-3.,adaptative_pivot=False):
    """
